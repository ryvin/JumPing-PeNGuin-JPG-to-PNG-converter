...
class JPGtoPNGConverter:
    ...
    def convert_image(self, source_path, dest_path):
        try:
            ...
            if self.progress_var:
                self.progress_var.set(int(self.converted_files / self.total_files * 100))
    ...
    def convert_jpg_to_png(self):
        ...
        with ThreadPoolExecutor() as executor:
            for file_path in image_files:
                ...
                executor.submit(self.convert_image, file_path, dest_path)
    ...
    def start_conversion(self):
        ...
        try:
            self.convert_jpg_to_png()
            self.status_label.config(text=f"Conversion complete. Converted {self.converted_files} files.")
        except Exception as e:
